...
class Chop extends React.Component {
  constructor(props) {
    super(props);
  }
  ...
  render() {
    return (
      <>
        <PageHeader title=" - chop" description="chop application"></PageHeader>
        <Navigation />
        <PageTitle title="Chop" />

        <Container>
          <SectionHeader header="Details"></SectionHeader>
          <body style={{ backgroundColor: '#3BB78F' }}>
            <div>
              The chop app is your kitchen assistant! Track all of your
              inventory, from fruits to snacks, always knowing what you have
              available in your kitchen. If you are ever at the shops and you
              are not sure what you have at home, chop has you covered.
            </div>
            <br></br>
            <div>
              For all enquiries, please use the contact form within the app at
              the top right corner speech bubble icon
            </div>
          </body>
        </Container>

        <Container>
          <SectionHeader header="Privacy Policy"></SectionHeader>
          ...
          <ul>
            ...
            <li>
              <p>
                <strong>Application</strong> refers to chop, the software
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to chop.
              </p>
            </li>
            <li>
              <p>
          ...
          <ul>
            <li>
              ...
              <a
                href="datrsciencewithdaniel.com.au"
                rel="external nofollow noopener"
                target="_blank"
              >
                datasciencewithdaniel.com.au/chop
              </a>
            </li>
          </ul>
        </Container>
